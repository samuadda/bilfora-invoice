        ...
        <header className="w-full h-20 flex items-center justify-between px-10 py-4 border-b border-gray-200">
            <div className="w-96 h-10">
                <input
                    type="text"
                    name="search"
                    className="w-full h-full bg-gray-50 border border-gray-300 text-gray-800 font-poppins py-2 px-4 rounded-xl focus:ring focus:ring-priblue focus:border-none outline-none"
                    placeholder="Invoice Number"
                />
            </div>
            <div className="flex items-center justify-end w-1/2">
                <div className="flex items-center justify-end w-1/2">
                    <button className="w-10 h-10 mx-1 rounded-full flex items-center justify-center hover:bg-gray-100 transition-colors duration-300">
